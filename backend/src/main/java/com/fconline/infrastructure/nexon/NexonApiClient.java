...
public class NexonApiClient implements NexonMatchGateway {
    ...
    private NexonParticipantData parseParticipant(JsonNode self, JsonNode opponent) {
        ...
        return new NexonParticipantData(
                ...
                pass.path("shortPassSuccess").asInt(0),
                pass.path("longPassTry").asInt(0),
                pass.path("longPassSuccess").asInt(0),
                pass.path("bouncingLobPassTry").asInt(0),
                pass.path("bouncingLobPassSuccess").asInt(0),
                pass.path("drivenGroundPassTry").asInt(0),
                pass.path("drivenGroundPassSuccess").asInt(0),
                pass.path("throughPassTry").asInt(0),
                pass.path("throughPassSuccess").asInt(0),
                pass.path("lobbedThroughPassTry").asInt(0),
                pass.path("lobbedThroughPassSuccess").asInt(0),
                defence.path("tackleTry").asInt(0),
                defence.path("tackleSuccess").asInt(0),
                defence.path("blockTry").asInt(0),
                defence.path("blockSuccess").asInt(0),
                ...
                matchDetail.path("matchEndType").isMissingNode() ? null : matchDetail.path("matchEndType").asInt(),
                matchDetail.path("systemPause").isMissingNode() ? null : matchDetail.path("systemPause").asInt(),
